// Không đặt loading.tsx ở đây: stream gửi mã trạng thái trước khi biết bản đọc có
// tồn tại hay không, nên notFound() trả 200 thay vì 404. Đo được: có → 200, bỏ → 404.
  ...
  return (
    <main id="noi-dung" className="min-h-screen bg-giay grid place-items-center p-6">
      <div className="max-w-md text-center">
        ...
        <Link href="/library" className="inline-block mt-6 px-5 py-3 rounded-lg bg-verso-700 text-white font-bold">
