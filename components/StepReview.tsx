...
import { loiDocCuaKhoi } from '@/lib/speechText';
import { taiTieng, LoiTieng, THONG_BAO_TIENG } from '@/lib/audioClient';
import { SuaBang } from './TableEditor';
import { HopGopY } from './FeedbackBox';
                ...
                <>
                  ...
                  {(k.maHinh || k.anhHinh) && (
                    <figure className="m-0 mb-3">
                      <img src={k.maHinh ? `/api/figure/${k.maHinh}` : k.anhHinh} alt=""
