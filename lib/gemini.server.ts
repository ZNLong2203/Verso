    ...
    khoi: {
      ...
      items: {
        ...
        properties: {
          ...
          soChuThich: { type: Type.STRING, description: 'CHỈ dùng cho loai="chu-thich": số thứ tự của chú thích, ví dụ "1". Phải khớp với dấu [chú thích 1] trong bài. Rỗng với loại khác.' },
          ngonNgu: { type: Type.STRING, description: 'Ngôn ngữ CHÍNH của khối: "vi" hoặc "en". Mặc định "vi". Dùng "en" khi cả khối là tiếng Anh (đoạn đọc hiểu, hội thoại, danh sách từ vựng).' },
